...
@pytest.mark.parametrize(("dt_str", "expected_timestamp"), [
    ("2020-09-01", datetime(2020, 9, 1, tzinfo=tz.utc).timestamp()),
    ("2020-02-28", datetime(2020, 2, 28, tzinfo=tz.utc).timestamp()),
    ("2021-01-16 09:56.52", datetime(2021, 1, 16, 9, 56, 52, tzinfo=tz.utc).timestamp()),
    ("2021-03-19 23:52.01", datetime(2021, 3, 19, 23, 52, 1, tzinfo=tz.utc).timestamp()),
    ("2021-03-19T23:52.01", datetime(2021, 3, 19, 23, 52, 1, tzinfo=tz.utc).timestamp())
])
